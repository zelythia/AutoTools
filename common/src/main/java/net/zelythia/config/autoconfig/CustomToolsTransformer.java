    ...
    public List<AbstractConfigListEntry> transform(List<AbstractConfigListEntry> list, String s, Field field, Object config, Object defaults, GuiRegistryAccess guiRegistryAccess) {
        ...
        l.setCellErrorSupplier(s1 -> {
            try {
                ...
                if (!jsonElement.isJsonObject())  return Optional.of(new TranslatableComponent("text.autoconfig.autotools.error.incorrect_json"));
            }catch (Exception e){
                return Optional.of(new TranslatableComponent("text.autoconfig.autotools.error.incorrect_json"));
            }
